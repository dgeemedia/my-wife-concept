// frontend/components/public/LanguageSwitcher.tsx
'use client'
...
export default function LanguageSwitcher() {
  ...
  return (
    <div className="relative">
      ...
      >
        <Globe className="w-4 h-4 text-gray-600 dark:text-gray-300 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors" />
      ...
      {isOpen && (
        <>
          ...
          {/* Dropdown Menu */}
          <div className="absolute right-0 mt-2 w-72 bg-white dark:bg-gray-900 rounded-xl shadow-2xl z-50 border border-gray-200 dark:border-gray-700 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
                  ...
                  {languages.map((lang: LanguageInfo) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full text-left px-4 py-2.5 hover:bg-gray-50 dark:hover:bg-gray-800 flex items-center gap-3 transition-all duration-150 ${
                          isActive 
