        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href="#products"
                className="inline-flex items-center justify-center px-8 py-4 border-2 border-gray-300 text-gray-700 rounded-xl font-semibold hover:border-primary-600 hover:text-primary-600 transition-colors"
              >
                View Menu
              </a>
            </div>
          ...
          <div className="relative">
              ...
              <div className="bg-white rounded-2xl p-6 space-y-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">30-45 minutes average</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Via WhatsApp verification</p>
                  </div>
                </div>
            ...
            {/* Floating Elements */}
            <div className="absolute -top-4 -right-4 w-24 h-24 bg-secondary-100 rounded-full flex items-center justify-center animate-bounce-slow">
              <ShoppingBag className="w-12 h-12 text-secondary-600" />
            </div>
            <div className="absolute -bottom-4 -left-4 w-20 h-20 bg-primary-100 rounded-full flex items-center justify-center animate-pulse">
